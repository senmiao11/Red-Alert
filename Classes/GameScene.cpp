...
bool GameScene::init()
{
	...
	base->setScale(0.4);
	base->setPosition(Vec2( 0,5));
	base->createBar();
	base->hpBar->setPosition(base->hpBar->getPosition() - Vec2(20, 0));
